...
public class AdminSupportBoardController {
    ...
    public String goSupportList(Model model, HttpSession session) {
        ...
        model.addAttribute("contentPage", "pages/adminSupportList.jsp");
    ...
    public String goSupportWrite(Model model) {
    	List<Board> boards = bs.getActiveBoards();
	    model.addAttribute("boards", boards);
        model.addAttribute("contentPage", "pages/adminSupportWrite.jsp");
        return "admin_layout";
    }
    ...
    public String goSupportView(@PathVariable Long sbNum, Model model, HttpSession session) {
        ...
        model.addAttribute("contentPage", "pages/adminSupportView.jsp");
        return "admin_layout";
    }
    ...
    public String goSupportEdit(@PathVariable Long sbNum, Model model) {
        SupportBoard sb = sbs.findByNum(sbNum);
        model.addAttribute("sb", sb);
        model.addAttribute("contentPage", "pages/adminSupportEdit.jsp");
        return "admin_layout";
    }

    @PutMapping("/{sbNum}")
    @ResponseBody
    public String updateSupport(@PathVariable Long sbNum, @RequestBody SupportBoard supportBoard, HttpSession session) {
        User loginUser = (User) session.getAttribute("loginUser");
    ...
    public String writeSupportPost(SupportBoard supportBoard) {
        ...
        return "redirect:/api/admin/supports/supportList";
    }
}
