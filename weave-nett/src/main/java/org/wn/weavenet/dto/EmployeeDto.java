...
public class EmployeeDto {
    ...
    public EmployeeDto(String eName, String eEmail, String deptName, String eGrade, String ePosition, String eAddress,
                       LocalDateTime eJoinDate, String uRank, String uStatus, String uAuth, Long uNum) {
        this.eName = eName;
        this.eEmail = eEmail;
    ...
    public EmployeeDto(String eNum, String eName, String eEmail, String deptName, String eGrade, String ePosition,
                       String eAddress, LocalDateTime eJoinDate, String uRank, String uStatus, String uAuth, Long uNum) {
        this.eNum = eNum;
        this.eName = eName;
        this.eEmail = eEmail;
        this.deptName = deptName;
