...
<body>
    <form id="writeForm" action="/api/admin/supports" method="post">
        ...
        <div id="button" class="btn_top">
            <span class="btnBc cancel medium">
            	<input type="button" value="취소" onclick="location.href='/api/admin/supports/supportList';">
            </span>
	...
	<table class="writeTypeA">
		...
		<tbody>
			...
			<tr>
				<th scope="row">제목</th>
				<td class="wrap">
					<div class="selectBox small" id="supportTypeBox">
