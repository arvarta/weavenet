...
<body>
	<div class="btn_top">
        <span class="btnBc outline medium">
			<input type="button" value="목록" onclick="location.href='/api/admin/supports/supportList';">
		</span>
    </div>
    <div class="viewTypeA">
		...
		<div class="post_actions">
			<c:if test="${ loginUserName == writer }">
				...
				<span class="btnBc outline medium">
					<input type="button" value="수정" onclick="location.href='/api/admin/supports/${sb.sbNum}/edit'" /> 
				</span>
				</c:if>
			</c:if>
		</div>
	...
	<script>
		...
		function deleteSupport(sbNum) {
			...
			.then(function(response) {
				if (response.ok) {
					alert('삭제되었습니다.');
					location.href = '/api/admin/supports/supportList';
				} else {
