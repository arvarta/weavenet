...
<body>
    ...
    <form id="writeForm" action="/api/supports" method="post">
        ...
        <div id="button">
            <span class="btnBc cancel small"><input type="button" value="취소" onclick="location.href='/api/admin/supports/supportList';"></span>
	...
	<script src="/js/select_board_modal.js"></script>
</body>
</html>
