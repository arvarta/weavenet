...
<body>
		...
		<tr>
			...
			<td class="subject">
				<span class="btnBc outline small">
					<input type="button" value="목록" onclick="location.href='/api/posts/postList';">
				</span>
			</td>
		</tr>
	</table>
	...
	<c:if test="${ loginUser.uNum == p.uNum or 
		...
		<div class="post-actions">
			<span class="btnBc outline small">
                <%-- ★★★ 내부 c:if 제거 및 수정 URL 확인 ★★★ --%>
				<input type="button" value="수정" onclick="location.href='/api/posts/${p.pNum}/edit'" /> 
			</span>
			<span class="btnBc outline small">
